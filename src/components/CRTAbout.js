            ...
            <div className='container mx-auto'>
                <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center sm:gap-[15px] lg:gap-[30px] xl:gap-[40px] pt-[65px] pb-[65px] mx-[5%] lg:mx-[4%] xl:mx-0 2xl:mx-[9%]'>
                    <div className='hidden sm:block sm:w-[60%]'>
                        <h1 className='text-[19px] lg:text-[25px] xl:text-[34px] text-black font-bold leading-[34px] lg:leading-[43px] xl:leading-[60px] ubuntu-bold'>Synthetic Chain <span className='text-transparent bg-gradient-to-r from-green-500 via-orange-500 to-red-500 bg-clip-text ubuntu-bold'>$CRT</span> Token smart contracts<br />Begin with <span className='text-[#4473B9] ubuntu-bold'>#Qtum</span> Decentralized Finance</h1>
                    ...
                    <div className='hidden sm:block sm:w-[40%]'>
                        <img src="/device-1.svg" alt="device" className='w-full h-auto sm:mt-[70px] lg:mt-[110px] xl:mt-[130px]' />
                    </div>
                    <div className='block sm:hidden'>
                        <h1 className='text-[24px] text-black font-bold leading-[36px] ubuntu-bold'>Synthetic Chain <span className='text-transparent bg-gradient-to-r from-green-500 via-orange-500 to-red-500 bg-clip-text ubuntu-bold'>$CRT</span> Token smart contracts<br />Begin with <span className='text-[#4473B9] ubuntu-bold'>#Qtum</span> Decentralized Finance</h1>

                        <div class=" bg-[#6b47ed] h-[6px] w-[54px] my-[25px]"></div>

                        <div className='flex justify-center'>
                            <img src="/device-1.svg" alt="device" className='w-[85%] h-auto mt-[10px]' />
                        </div>
