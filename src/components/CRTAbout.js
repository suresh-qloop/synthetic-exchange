        ...
        <div className='container mx-auto'>
            <div className='flex flex-col sm:flex-row sm:justify-between sm:items-center sm:gap-[15px] lg:gap-[30px] xl:gap-[40px] pt-[65px] pb-[65px] mx-[5%] lg:mx-[4%] xl:mx-0 2xl:mx-[9%]'>
                <div className='hidden sm:block sm:w-[60%]'>
                    <h1 className='text-[19px] lg:text-[25px] xl:text-[35px] text-black font-bold leading-[30px] lg:leading-[43px] xl:leading-[60px]'>Synthetic Chain <span className='text-[#6b47ed]'>$CRT</span> Token smart contracts<br />Begin with <span className='text-[#6b47ed]'>#Qtum</span> Decentralized Finance rails</h1>
                ...
                <h1 className='text-[24px] text-black font-bold leading-[36px]'>Synthetic Chain <span className='text-[#6b47ed]'>$CRT</span> Token smart contracts<br />Begin with <span className='text-[#6b47ed]'>#Qtum</span> Decentralized Finance rails</h1>
